...
internal static class Messages
{
    ...
    public const string RegexDuplicateCaptureGroupName = "Invalid regular expression: Duplicate capture group name";
    public const string RegexIncompleteQuantifier = "Invalid regular expression: Incomplete quantifier";
    public const string RegexInvalidCaptureGroupName = "Invalid regular expression: Invalid capture group name";
    public const string RegexInvalidEscape = "Invalid regular expression: Invalid escape";
    public const string RegexInvalidDecimalEscape = "Invalid regular expression: Invalid decimal escape";
    public const string RegexInvalidCharacterClass = "Invalid regular expression: Invalid character class";
    public const string RegexInvalidClassEscape = "Invalid regular expression: Invalid class escape";
    public const string RegexInvalidGroup = "Invalid regular expression: Invalid group";
    public const string RegexInvalidPropertyName = "Invalid regular expression: Invalid property name";
    public const string RegexInvalidPropertyNameInCharacterClass = "Invalid regular expression: Invalid property name in character class";
    public const string RegexInvalidNamedCaptureReferenced = "Invalid regular expression: Invalid named capture referenced";
    public const string RegexInvalidNamedReference = "Invalid regular expression: Invalid named reference";
    public const string RegexInvalidQuantifier = "Invalid regular expression: Invalid quantifier";
    public const string RegexNothingToRepeat = "Invalid regular expression: Nothing to repeat";
    public const string RegexInvalidUnicodeEscape = "Invalid regular expression: Invalid Unicode escape";
    public const string RegexLoneQuantifierBrackets = "Invalid regular expression: Lone quantifier brackets";
    public const string RegexNumbersOutOfOrderInQuantifier = "Invalid regular expression: numbers out of order in {} quantifier";
    public const string RegexRangeOutOfOrderInCharacterClass = $"Invalid regular expression: Range out of order in character class";
