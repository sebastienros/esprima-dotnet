...
internal static class Messages
{
    ...
    public const string RegexDuplicateCaptureGroupName = "Invalid regular expression: /{0}/{1}: Duplicate capture group name";
    public const string RegexIncompleteQuantifier = "Invalid regular expression: /{0}/{1}: Incomplete quantifier";
    public const string RegexInvalidCaptureGroupName = "Invalid regular expression: /{0}/{1}: Invalid capture group name";
    public const string RegexInvalidEscape = "Invalid regular expression: /{0}/{1}: Invalid escape";
    public const string RegexInvalidDecimalEscape = "Invalid regular expression: /{0}/{1}: Invalid decimal escape";
    public const string RegexInvalidCharacterClass = "Invalid regular expression: /{0}/{1}: Invalid character class";
    public const string RegexInvalidClassEscape = "Invalid regular expression: /{0}/{1}: Invalid class escape";
    public const string RegexInvalidGroup = "Invalid regular expression: /{0}/{1}: Invalid group";
    public const string RegexInvalidPropertyName = "Invalid regular expression: /{0}/{1}: Invalid property name";
    public const string RegexInvalidPropertyNameInCharacterClass = "Invalid regular expression: /{0}/{1}: Invalid property name in character class";
    public const string RegexInvalidNamedCaptureReferenced = "Invalid regular expression: /{0}/{1}: Invalid named capture referenced";
    public const string RegexInvalidNamedReference = "Invalid regular expression: /{0}/{1}: Invalid named reference";
    public const string RegexInvalidQuantifier = "Invalid regular expression: /{0}/{1}: Invalid quantifier";
    public const string RegexNothingToRepeat = "Invalid regular expression: /{0}/{1}: Nothing to repeat";
    public const string RegexInvalidUnicodeEscape = "Invalid regular expression: /{0}/{1}: Invalid Unicode escape";
    public const string RegexLoneQuantifierBrackets = "Invalid regular expression: /{0}/{1}: Lone quantifier brackets";
    public const string RegexNumbersOutOfOrderInQuantifier = "Invalid regular expression: /{0}/{1}: numbers out of order in {{}} quantifier";
    public const string RegexRangeOutOfOrderInCharacterClass = "Invalid regular expression: /{0}/{1}: Range out of order in character class";
    public const string RegexUnmatchedOpenParen = "Invalid regular expression: /{0}/{1}: Unmatched ')'";
    public const string RegexUnterminatedCharacterClass = "Invalid regular expression: /{0}/{1}: Unterminated character class";
    public const string RegexUnterminatedGroup = "Invalid regular expression: /{0}/{1}: Unterminated group";
